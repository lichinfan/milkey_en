...
import com.kentec.milkbox.checkout.task.CheckoutTaskSetCoupons;
...
public class CouponView extends LinearLayout {
	...
	public void show() {		
		...
		showCurrent();
		// 自動選擇 all coupon
//		setCoupons(mActivity.getData().getCouponList());
	...
	public void setCoupons(ArrayList<Coupon> coupons) {
		new CheckoutTaskSetCoupons(mActivity, coupons).execute();
	}
