...
import com.kentec.milkbox.weather.yahoo.LoadPlaceWOEIDTask;
import com.kentec.milkbox.weather.yahoo.YahooWeather;
import com.kentec.milkbox.weather.yahoo.LoadPlaceWOEIDTask.OnLoadPlaceWOEIDListener;
import com.kentec.milkbox.weather.yahoo.LoadWeatherConditionTask;
import com.kentec.milkbox.weather.yahoo.LoadWeatherConditionTask.OnLoadWeatherConditionListener;;
...
public class MainActivity extends ASRActivity implements OnClickListener, OnFocusChangeListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		//		CFG.initHost("http://emilk.kenmec.com/setupboxen");
...
//		cityText = (TextView) findViewById(R.id.cityText);
		...
		imeiText.setText(CFG.IMEI);
		imeiText.setOnClickListener(new View.OnClickListener() {
			...
			public void run() {
				runOnUiThread(new Runnable() {
					...
					public void run() {
						if(flagForBackgroundLoad == true) {
							flagForWeatherLoad = false;
							new LoadPlaceWOEIDTask(TimeZone.getDefault().getID().split("/")[1], new OnLoadPlaceWOEIDListener() {
								
								@Override
								public void OK(ArrayList<String> l) {
									new LoadWeatherConditionTask(l.get(0), new OnLoadWeatherConditionListener() {
										
										@Override
										public void OK(YahooWeather yahooWeatherResult) {
											CFG.YAHOOWEATHER = yahooWeatherResult;
											temp.setText(yahooWeatherResult.getTemperature());
											condDescr.setText(yahooWeatherResult.getConditiontext());
											SimpleDateFormat sdf = new SimpleDateFormat("HH");
											String h = sdf.format(new Date());
											int currentHour = Integer.parseInt(h);
											changeBackground(currentHour, yahooWeatherResult.getCode());
...
//            								      intent.getExtras().getString("WeatherIconStr"));
            changeBackground(intent.getExtras().getInt("CurrentHour"), intent.getExtras().getString("WeatherCodeStr"));
            System.out.println("yahoo weacher change code: "+intent.getExtras().getString("WeatherCodeStr"));
            /*
...
//			condDescr.setText(weather.currentCondition.getCondition() + "(" + weather.currentCondition.getDescr() + ")");
	...
	public void changeBackground(int currentHour, String weatherCode) {
		...
		final int[] bgMistDayImages = {R.drawable.main_bg_mist_d, R.drawable.main_bg_mist_d2};
		final int[] bgMistNightImages = {R.drawable.main_bg_mist_n, R.drawable.main_bg_mist_n2};
		...
		HashMap<String, Object[]> weatherCondAndIcon = new HashMap<String, Object[]>();
		weatherCondAndIcon.put("0",new Object[] {"Thunderstorm",R.drawable.weather_thunder}); // yahoo weather code: 0
		weatherCondAndIcon.put("1",new Object[] {"Thunderstorm",R.drawable.weather_thunder}); // yahoo weather code: 1
		weatherCondAndIcon.put("2",new Object[] {"Thunderstorm",R.drawable.weather_thunder}); // yahoo weather code: 2
		weatherCondAndIcon.put("3",new Object[] {"Thunderstorm",R.drawable.weather_thunder}); // yahoo weather code: 3
		weatherCondAndIcon.put("4",new Object[] {"Thunderstorm",R.drawable.weather_thunder}); // yahoo weather code: 4
		weatherCondAndIcon.put("5",new Object[] {"Thunderstorm",R.drawable.weather_thunder}); // yahoo weather code: 5
		weatherCondAndIcon.put("6",new Object[] {"Thunderstorm",R.drawable.weather_thunder}); // yahoo weather code: 6
		weatherCondAndIcon.put("7",new Object[] {"Thunderstorm",R.drawable.weather_thunder}); // yahoo weather code: 7
		weatherCondAndIcon.put("8",new Object[] {"Rain",R.drawable.weather_rain}); // yahoo weather code: 8
		weatherCondAndIcon.put("9",new Object[] {"Rain",R.drawable.weather_rain}); // yahoo weather code: 9
		weatherCondAndIcon.put("10",new Object[] {"Rain",R.drawable.weather_rain}); // yahoo weather code: 10
		weatherCondAndIcon.put("11",new Object[] {"Rain",R.drawable.weather_rain}); // yahoo weather code: 11
		weatherCondAndIcon.put("12",new Object[] {"Rain",R.drawable.weather_rain}); // yahoo weather code: 12
		weatherCondAndIcon.put("13",new Object[] {"Snow",R.drawable.weather_snow}); // yahoo weather code: 13
		weatherCondAndIcon.put("14",new Object[] {"Snow",R.drawable.weather_snow}); // yahoo weather code: 14
		weatherCondAndIcon.put("15",new Object[] {"Snow",R.drawable.weather_snow}); // yahoo weather code: 15
		weatherCondAndIcon.put("16",new Object[] {"Snow",R.drawable.weather_snow}); // yahoo weather code: 16
		weatherCondAndIcon.put("17",new Object[] {"Snow",R.drawable.weather_snow}); // yahoo weather code: 17
		weatherCondAndIcon.put("18",new Object[] {"Snow",R.drawable.weather_snow}); // yahoo weather code: 18
		weatherCondAndIcon.put("19",new Object[] {"Mist",R.drawable.weather_mist}); // yahoo weather code: 19
		weatherCondAndIcon.put("20",new Object[] {"Mist",R.drawable.weather_mist}); // yahoo weather code: 20
		weatherCondAndIcon.put("21",new Object[] {"Mist",R.drawable.weather_mist}); // yahoo weather code: 21
		weatherCondAndIcon.put("22",new Object[] {"Mist",R.drawable.weather_mist}); // yahoo weather code: 22
		weatherCondAndIcon.put("23",new Object[] {"Mist",R.drawable.weather_mist}); // yahoo weather code: 23
		weatherCondAndIcon.put("24",new Object[] {"Mist",R.drawable.weather_mist}); // yahoo weather code: 24
		weatherCondAndIcon.put("25",new Object[] {"Mist",R.drawable.weather_mist}); // yahoo weather code: 25
		weatherCondAndIcon.put("26",new Object[] {"Clouds",R.drawable.weather_cloudy}); // yahoo weather code: 26
		weatherCondAndIcon.put("27",new Object[] {"Clouds",R.drawable.weather_mist}); // yahoo weather code: 27
		weatherCondAndIcon.put("28",new Object[] {"Clouds",R.drawable.weather_cloudy}); // yahoo weather code: 28
		weatherCondAndIcon.put("29",new Object[] {"Clouds",R.drawable.weather_mist}); // yahoo weather code: 29
		weatherCondAndIcon.put("30",new Object[] {"Clouds",R.drawable.weather_cloudy}); // yahoo weather code: 30
		weatherCondAndIcon.put("31",new Object[] {"Sunny",R.drawable.weather_sun_n}); // yahoo weather code: 31
		weatherCondAndIcon.put("32",new Object[] {"Sunny",R.drawable.weather_sun_d}); // yahoo weather code: 32
		weatherCondAndIcon.put("33",new Object[] {"Sunny",R.drawable.weather_sun_n}); // yahoo weather code: 33
		weatherCondAndIcon.put("34",new Object[] {"Sunny",R.drawable.weather_sun_d}); // yahoo weather code: 34
		weatherCondAndIcon.put("35",new Object[] {"Rain",R.drawable.weather_rain}); // yahoo weather code: 35
		weatherCondAndIcon.put("36",new Object[] {"Sunny",R.drawable.weather_sun_d}); // yahoo weather code: 36
		weatherCondAndIcon.put("37",new Object[] {"Thunderstorm",R.drawable.weather_thunder}); // yahoo weather code: 37
		weatherCondAndIcon.put("38",new Object[] {"Thunderstorm",R.drawable.weather_thunder}); // yahoo weather code: 38
		weatherCondAndIcon.put("39",new Object[] {"Thunderstorm",R.drawable.weather_thunder}); // yahoo weather code: 39
		weatherCondAndIcon.put("40",new Object[] {"Thunderstorm",R.drawable.weather_thunder}); // yahoo weather code: 40
		weatherCondAndIcon.put("41",new Object[] {"Snow",R.drawable.weather_snow}); // yahoo weather code: 41
		weatherCondAndIcon.put("42",new Object[] {"Snow",R.drawable.weather_snow}); // yahoo weather code: 42
		weatherCondAndIcon.put("43",new Object[] {"Snow",R.drawable.weather_snow}); // yahoo weather code: 43
		weatherCondAndIcon.put("44",new Object[] {"Clouds",R.drawable.weather_cloudy}); // yahoo weather code: 44
		weatherCondAndIcon.put("45",new Object[] {"Thunderstorm",R.drawable.weather_thunder}); // yahoo weather code: 45
		weatherCondAndIcon.put("46",new Object[] {"Snow",R.drawable.weather_snow}); // yahoo weather code: 46
		weatherCondAndIcon.put("47",new Object[] {"Thunderstorm",R.drawable.weather_thunder}); // yahoo weather code: 47
		...
		try {
			...
			if ("Clouds".equalsIgnoreCase((String) weatherCondAndIcon.get(weatherCode)[0]))
			{
			...
			else if ("Mist".equalsIgnoreCase((String) weatherCondAndIcon.get(weatherCode)[0]))
			{
				if(currentHour > 6 && currentHour <= 16)
					bmpDrawBGImg = new BitmapDrawable(getResources().openRawResource(this.getRandomImage(bgMistDayImages)));
				else
					bmpDrawBGImg = new BitmapDrawable(getResources().openRawResource(this.getRandomImage(bgMistNightImages)));
			}
			else if ("Thunderstorm".equalsIgnoreCase((String) weatherCondAndIcon.get(weatherCode)[0]))
			{
				if(currentHour > 6 && currentHour <= 16)
			...
			else if ("Rain".equalsIgnoreCase((String) weatherCondAndIcon.get(weatherCode)[0]) || "Drizzle".equalsIgnoreCase((String) weatherCondAndIcon.get(weatherCode)[0]))
			{
				if(currentHour > 6 && currentHour <= 16)
			...
			else if ("Snow".equalsIgnoreCase((String) weatherCondAndIcon.get(weatherCode)[0]) )
			{
				if(currentHour > 6 && currentHour <= 16)
			...
			imgView.setImageResource((Integer) weatherCondAndIcon.get(weatherCode)[1]);
		} catch (Exception e) {
			e.printStackTrace();
		}
