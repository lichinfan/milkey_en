...
public abstract class IntrouctionScriptAdapter
{
	...
	private String weatherCodeStr; // for MainActivity.java->changeBackground argument, 天氣 icon 檔名，如 01d, 01n
	...
	public IntrouctionScriptAdapter(String echoStr[], String speakStr[], int ms, int resId, int x, int y, int currentHour, String weatherCodeStr)
	{
		this.strEcho = echoStr;
		this.strSpeak = speakStr;
		this.showTime = ms;
		...
		this.locationY = y;
		this.currentHour = currentHour;
		this.weatherCodeStr = weatherCodeStr;
	}
	...
	public String getWeatherCodeStr() {
		return weatherCodeStr;
	}

	public void setWeatherCodeStr(String weatherCodeStr) {
		this.weatherCodeStr = weatherCodeStr;
	}
