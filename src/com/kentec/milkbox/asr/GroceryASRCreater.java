	...
	private void initASRCMDAdapter()
	{
		...
		*/
		mGroceryMainActivity.addASRCMDAdapter(new ASRCMDAdapter(ASRString.getResourceString(mGroceryMainActivity.getResources(), R.array.grocery))
		{
			...
			public void action()
			{
				MilkBoxTTS.speak("You're already in Grocery.", "echoAlreadyInGrocery");
			}
		...
		mGroceryMainActivity.addASRCMDAdapter(new ASRCMDAdapter(	ASRString.getResourceString(mGroceryMainActivity.getResources(), R.array.UserGuide))
		{
			@Override
			public void action() {}
		...
		mGroceryMainActivity.addASRCMDAdapter(new ASRCMDAdapter(ASRString.getResourceString(mGroceryMainActivity.getResources(), R.array.checkorderstatus))
		{
			@Override
			public void action()
			{
				mGroceryMainActivity.openLoadOrderHistory();
			}
		...
		*/
		...
		mGroceryMainActivity.addASRCMDAdapter(new ASRCMDAdapter(ASRString.getResourceString(mGroceryMainActivity.getResources(), R.array.menu))
		{
			...
			public void action()
			{
				...
				* 加入語音
				*/
				String strMsg = "Let's get back to main menu.";
				// 唸出資訊
		...
		*/
		 ...
		 * page * 指令
		*/
		/*mGroceryMainActivity.addASRCMDAdapter(new ASRCMDAdapter(ASRString.getResourceString(mGroceryMainActivity.getResources(), R.array.voicemode))
		{
			@Override
			public void action()
			{
				mGroceryMainActivity.govoicemode();
			}
