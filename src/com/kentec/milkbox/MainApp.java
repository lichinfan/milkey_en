...
public class MainApp extends Application
{
	...
	public boolean matchFirst = true;
	public boolean moderatorSW = false;
	@Override
...
//			CFG.initHost(CFG.mfs.getServer1().trim()); // get Server1 valus
			CFG.initHost("http://54.187.180.50/boxen/");
			CFG.initNickName(CFG.mfs.getNickName().trim()); // get NickName value
//			CFG.IMEI = CFG.mfs.getIMEI();
//			CFG.IMEI = "6204102B06106200A";
			CFG.IMEI = "0006F01D0230B9052";
			
			Log.e("CFG.IMEI", CFG.IMEI);
